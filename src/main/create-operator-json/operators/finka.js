...
finka.addCounterNode(operatorId.caviera, counterType.soft, "Finka can use her Adrenal Surge to revive a downed ally, preventing an interrogation from Caveira, as this ally cannot be downed again.");
...
finka.addCounterNode(operatorId.melusi, counterType.soft, "Finka's Adrenal Surge allows attackers to move through Melusi's Banshee without being slowed down.");

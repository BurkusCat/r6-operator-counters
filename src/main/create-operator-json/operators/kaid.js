...
kaid.addCounterNode(operatorId.dokkaebi, counterType.minor, "Kaid's Electroclaws can destroy a defender's phone if it is dropped into electrified barbed wire.")

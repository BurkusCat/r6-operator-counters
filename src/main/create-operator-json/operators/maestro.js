...
maestro.addCounterNode(operatorId.iana, counterType.soft, "Maestro's Evil Eye can destroy Iana's Hologram with its laser and can detect its lack of heat signature.");
maestro.addCounterNode(operatorId.zero, counterType.soft, "Maestro's Evil Eye can destroy Zero's Argus cameras.");

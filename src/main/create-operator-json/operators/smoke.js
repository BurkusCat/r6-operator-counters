...
smoke.addCounterNode(operatorId.finka, counterType.soft, "Smoke's Gas Grenades deal the double amount of damage to Attackers boosted by Finka's Adrenal Surge.");

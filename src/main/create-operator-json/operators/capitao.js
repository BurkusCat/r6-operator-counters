...
capitao.addCounterNode(operatorId.clash, counterType.hard, "Capitão's Tactical Crossbow can fire asphyxiating bolts that can be used to easily take out Clash.");
